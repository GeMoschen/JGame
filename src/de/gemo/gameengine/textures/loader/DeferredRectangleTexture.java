 ...
 * @author kevin
 */
public class DeferredRectangleTexture extends RectangleTexture implements DeferredResource {
    ...
    private RectangleTexture target;
     ...
     */
    public DeferredRectangleTexture(InputStream in, String resourceName, boolean flipped, int filter, int[] trans) {
        this.in = in;
    ...
    public void load() throws IOException {
        boolean before = RectangleTextureLoaderImpl.get().isDeferredLoading();
        RectangleTextureLoaderImpl.get().setDeferredLoading(false);
        target = RectangleTextureLoaderImpl.get().getTexture(in, resourceName, flipped, filter, trans);
        RectangleTextureLoaderImpl.get().setDeferredLoading(before);
    }
