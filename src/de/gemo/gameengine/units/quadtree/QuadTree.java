...
public class QuadTree<T> {
     ...
     *         been provided.
     */
    public Object get(double x, double y, T opt_default) {
    ...
    public List<Point<T>> searchIntersect(final double xmin, final double ymin, final double xmax, final double ymax) {
        final List<Point<T>> arr = new ArrayList<Point<T>>();
    ...
    public List<Point<T>> searchWithin(final double xmin, final double ymin, final double xmax, final double ymax) {
        final List<Point<T>> arr = new ArrayList<Point<T>>();
        this.navigate(this.root_, new Func<T>() {
            @Override
            public void call(QuadTree<T> quadTree, Node<T> node) {
     ...
     *        node. This function takes the node as an argument, and its return
     *        value is irrelevant.
     * @private
     */
